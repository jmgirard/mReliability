function [SCOTTPI, P_O, P_C] = mSCOTTPI(CODES, CATEGORIES, WEIGHTING)
% Calculate Scott's pi coefficient using generalized formula
%   [SCOTTPI, P_O, P_C] = mSCOTTPI(CODES, CATEGORIES, SCALE)
%
...
%
%   SCOTTPI is a chance-corrected index of agreement.
%
...
%
%   Example usage: mSCOTTPI(fishdata, [1, 2, 3], 'linear')
%   

function [KAPPA, P_A, P_E, SE, CI, IMP, BM] = KAPPA_G(DATA, TYPE, RATIO)
% Calculate Kappa G or Gwet's Agreement Coefficient
%   [KAPPA, P_A, P_E, SE, CI, IMP, BM] = KAPPA_G(DATA, TYPE, RATIO)
%
...
%	agreement using both category- and distribution-based approaches.
%
...
for i = 1:n
    ...
    gammastar_i = gamma_i - 2 * (1 - KAPPA) * ((p_e_i(i) - P_E) / (1 - P_E));
    v_inner(i) = (gammastar_i - KAPPA) ^ 2;
end
